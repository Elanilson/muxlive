...
import br.com.apkdoandroid.muxlive.helper.mux.MuxStatsMediaPlayer;
...
public class PlayerActivity extends Activity implements MediaPlayer.OnPreparedListener,
  ...
  //  private static final String MUX_ENVIRONMENT_KEY = "YOUR_ENVIRONMENT_KEY";
    private static final String MUX_ENVIRONMENT_KEY = Constantes.CHAVE_DE_AMBIENTE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // customerVideoData.setVideoTitle(intent.getStringExtra(VIDEO_TITLE_EXTRA));
        customerVideoData.setVideoTitle("Live");
            ...
            try {
              //  Intent intent = getIntent();
                ...
                if (extras != null) {
                    ...
                    player.setDataSource(this,  Uri.parse("https://stream.mux.com/"+streamKey+".m3u8"));
                    player.prepareAsync();
                }else{
