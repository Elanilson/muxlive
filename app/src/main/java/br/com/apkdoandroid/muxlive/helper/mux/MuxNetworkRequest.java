package br.com.apkdoandroid.muxlive.helper.mux;
...
import br.com.apkdoandroid.muxlive.helper.mux.compat.AsyncTaskCompat;

public class MuxNetworkRequest implements INetworkRequest {

  private static final String TAG = "MuxNetworkRequest";
  ...
  private static class NetworkTaskRunner extends AsyncTask<NetworkRequest, Void, Void> {
    ...
    protected Void doInBackground(NetworkRequest... params) {
      ...
      Log.d(TAG, "making " + method + " request to: " + url.toString() + "\nbody: " + body);
