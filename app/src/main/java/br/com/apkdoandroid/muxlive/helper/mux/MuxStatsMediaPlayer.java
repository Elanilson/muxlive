...
public class MuxStatsMediaPlayer extends EventBus implements IPlayerListener,
  ...
  /**
   * Should be set to true once {@link MediaPlayer#setDataSource} has been called. Should be set to
   * false if {@link MediaPlayer#reset} is called on the encapsulated player.
   */
